...
export default function AddAssurancePage() {
  ...
  return (
    <Layout>
      <div className="max-w-8xl mx-auto p-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold">Ajouter une nouvelle assurance</h1>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Date prochaine échéance<span className="text-red-500"> *</span></FormLabel>
                    {/* <FormControl>
                      <Input type="date" {...field} disabled={loading} />
                    </FormControl> */}
                    <Popover>
            ...
            <div className="flex gap-4">
              <Button type="submit" disabled={loading}>
                {loading ? "Traitement..." : "Créer l'assurance"}
              </Button>
