...
export default function AddVidangePage() {
  ...
  const onSubmit = useCallback(
    async (values: z.infer<typeof formSchema>) => {
      ...
      try {
        ...
        toast({
          title: "Succès",
          description: "Vidange créée avec succès!",
        })
  ...
  return (
    <Layout>
      <div className="max-w-8xl mx-auto p-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold">Ajouter une nouvelle vidange</h1>
        </div>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex gap-4">
              <Button type="submit" disabled={loading}>
                {loading ? "Traitement..." : "Créer la vidange"}
              </Button>
